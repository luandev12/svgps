...
const MapBoxPro = fabric.util.createClass(fabric.Group, {
  type: 'mapBoxPro',
  async: true,
...
MapBoxPro.fromObject = (options, callback) => {
  return callback(new MapBoxPro(options));
};

fabric.MapBoxPro = MapBoxPro;
